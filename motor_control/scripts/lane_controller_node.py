...
import numpy as np
import math
from turtlebot3_auto_msgs.msg import  Twist2DStamped, LanePose
...
class motor_controller(object):
    ...
    def cbPose(self,lane_pose_msg):
        ...
        twist.angular.x = self.v_bar; twist.angular.y = 0; twist.angular.z = 0  
        ...
        twist.angular.x = 0; twist.angular.y = 0; twist.angular.z =  self.k_d * cross_track_err + self.k_theta * heading_err
